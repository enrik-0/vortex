...
/**
 * All the Status defined in <b>HTTP</b>
 */
public
enum HttpStatus implements HttpStateCode{
     ...
     */
    SWITCHING_PROTOCOLS(101, "The server understands and is willing to comply with the client's request"),
    /**
     ...
     */
    NON_AUTHORITATIVE_INFORMATION(203, " The returned metainformation in the entity-header is not the" +
     ...
     */
    RESET_CONTENT(205, "The server has fulfilled the request and the user agent SHOULD reset\r\n" +
     ...
     */
    MOVED_PERMANENTLY(301, "The requested resource has been assigned a new permanent URI and any" +
     ...
     */
    SEE_OTHER(303, "The response to the request can be found under a different URI and" +
     ...
     */
    NOT_MODIFIED(304, " If the client has performed a conditional GET request and access is" +
     ...
     */
    METHOD_NOT_ALLOWED(405, "The method specified in the Request-Line is not allowed"),
    /**
     ...
     */
    LENGTH_REQUIRED(411, "The server refuses to accept the request without a defined Content-Length" + "   Length"),
    /**
     ...
     */
    PRECONDITION_FAILED(412, "he precondition given in one or more of the request-header fields" +
     ...
     */
    REQUEST_ENTITY_TOO_LARGE(413, " The server is refusing to process a request because the request" +
     ...
     */
    REQUEST_URI_TOO_LONG(414, " The server is refusing to service the request because the Request-URI" +
     ...
     */
    BAD_GATEWAY(502, "The server, while acting as a gateway or proxy, received an invalid" + "   response"),
