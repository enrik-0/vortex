...
/**
 * metadata of {@link HttpStatus} that could be useful
 */
public
interface HttpStateCode extends Serializable{
     ...
     * @throws IllegalArgumentException if {@code code} is not a three-digit positive number
     */
    static
     ...
     */
    default
    boolean isSameCodeAs(HttpStateCode other){
