...
class SQLWriter{
    ...
    public static
    String insert(Class<?> clazz, Map<String, Object> values) throws DataTypeException{
    ...
    public static
    String insert(DBTable table, Map<String, Object> values) throws DataTypeException{
    ...
    public static
    String insertAll(Class<?> clazz, List<Map<String, Object>> values){
        StringBuilder builder = new StringBuilder();
    ...
    public static
    String find(Map<String, Object> filter, DBTable table){
        StringBuilder builder = new StringBuilder();
        StringJoiner whereJoiner = new StringJoiner(" and ");
        StringJoiner paramJoiner = new StringJoiner(",");
        table.records().forEach(r -> {
			if(r.saved()){paramJoiner.add(String.format("%s as %s", r.name(), r.name()));}
        });
    ...
    public static
    String update(DBTable table, Map<String, Object> values){
        StringJoiner whereJoiner = new StringJoiner(" and ");
    ...
    public static
    String delete(DBTable table, Map<String, Object> where){
        if(where.isEmpty()){
            return null;
        }
        StringJoiner whereJoiner = new StringJoiner(" and ");
